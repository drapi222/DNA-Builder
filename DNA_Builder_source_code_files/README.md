...
### Virtual Meta Quest 3 testing

A Three.js/WebXR lab with an emulated Quest 3 headset and controllers is available in [`vr/`](vr/README.md). It reuses the Flask build API and automatically installs Meta's IWER virtual runtime on desktop browsers without native WebXR support.
